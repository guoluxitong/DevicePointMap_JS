...
export default class devicePointMap_CTL_RT_H1_RYRS extends map {
  constructor() {
    ...
    this.getPointMap["_ranshaoqi"] = byteFieldObj.init(new deviceField(), "_ranshaoqi", 0, 0, "燃烧器", false)
    this.getPointMap["_xunhuanbeng"] = byteFieldObj.init(new deviceField(), "_xunhuanbeng", 0, 0, "循环泵", false)
    
    this.getPointMap[deviceModel.key_point_system_status] = byteFieldObj.init(new baseInfoField(),deviceModel.key_point_system_status,3,2,"控制器状态",ctl_njrt_common_valueMap.coms_zhuangtai)
    ...
    this.getPointMap["oc_ranshaoqikongzhi"] = byteFieldObj.init(new deviceField(), "oc_ranshaoqikongzhi", 9, 2, "燃烧器启停控制", coms_open_close, 0)
    this.getPointMap["oc_ranshaoqibilijianda"] = byteFieldObj.init(new openCloseField(), "oc_ranshaoqibilizengda_ranshaoqixiaohuo_", 9, 2, "燃烧器比例增加", coms_open_close, 1)
    ...
    this.getPointMap["oc_bushuibengzhukongzhi"] = byteFieldObj.init(new deviceField(), "oc_bushuibengzhukongzhi", 9, 2, "补水泵主控制", coms_open_close, 3)
    this.getPointMap["oc_bushuibengbeikongzhi"] = byteFieldObj.init(new deviceField(), "oc_bushuibengbeikongzhi", 9, 2, "补水泵备控制", coms_open_close, 4)
    this.getPointMap["oc_xunhuanbengzhukongzhi"] = byteFieldObj.init(new deviceField(), "oc_xunhuanbengzhukongzhi", 9, 2, "循环泵主控制", coms_open_close, 5)
    this.getPointMap["oc_xunhuanbengbeikongzhi"] = byteFieldObj.init(new deviceField(), "oc_xunhuanbengbeikongzhi", 9, 2, "循环泵备控制", coms_open_close, 6)
