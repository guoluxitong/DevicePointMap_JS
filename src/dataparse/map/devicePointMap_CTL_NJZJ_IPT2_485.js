...
export default class devicePointMap_CTL_NJZJ_IPT2_485 extends map {
    constructor() {
        ...
        this.getPointMap["ex_1#guodianliubaojing"] = byteFieldObj.init(new exceptionField(), "ex_1#guodianliubaojing", 337, 2, "1#过电流报警")
        this.getPointMap["ex_2#guodianliubaojing"] = byteFieldObj.init(new exceptionField(), "ex_2#guodianliubaojing", 339, 2, "2#过电流报警")
        this.getPointMap["ex_3#guodianliubaojing"] = byteFieldObj.init(new exceptionField(), "ex_3#guodianliubaojing", 341, 2, "3#过电流报警")
        this.getPointMap["ex_4#guodianliubaojing"] = byteFieldObj.init(new exceptionField(), "ex_4#guodianliubaojing", 343, 2, "4#过电流报警")
        this.getPointMap["ex_5#guodianliubaojing"] = byteFieldObj.init(new exceptionField(), "ex_5#guodianliubaojing", 345, 2, "5#过电流报警")
        this.getPointMap["ex_gufengjiguzhangbaojing"] = byteFieldObj.init(new exceptionField(), "ex_gufengjiguzhangbaojing", 347, 2, "鼓风机故障报警")
        this.getPointMap["ex_jiezhigaowenbaojing"] = byteFieldObj.init(new exceptionField(), "ex_jiezhigaowenbaojing", 349, 2, "介质高温报警")
        this.getPointMap["ex_jiezhidiwenbaojing"] = byteFieldObj.init(new exceptionField(), "ex_jiezhidiwenbaojing", 351, 2, "介质低温报警")
        //
        ...
        this.getPointMap["ex_zhengqiwenduchuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_zhengqiwenduchuanganqiguzhang", 764, 2, "蒸汽温度传感器故障")
        this.getPointMap["ex_shineiwenduchuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_shineiwenduchuanganqiguzhang", 766, 2, "室内温度传感器故障")
        this.getPointMap["ex_1#dianliufankuichuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_1#dianliufankuichuanganqiguzhang", 768, 2, "1#电流反馈传感器故障")
        this.getPointMap["ex_2#dianliufankuichuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_2#dianliufankuichuanganqiguzhang", 770, 2, "2#电流反馈传感器故障")
        this.getPointMap["ex_3#dianliufankuichuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_3#dianliufankuichuanganqiguzhang", 772, 2, "3#电流反馈传感器故障")
        this.getPointMap["ex_4#dianliufankuichuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_4#dianliufankuichuanganqiguzhang", 774, 2, "4#电流反馈传感器故障")
        this.getPointMap["ex_5#dianliufankuichuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_5#dianliufankuichuanganqiguzhang", 776, 2, "5#电流反馈传感器故障")
        this.getPointMap["ex_jiezhiwenduchuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_jiezhiwenduchuanganqiguzhang", 778, 2, "介质温度传感器故障")
        this.getPointMap["ex_xiyuwenduchuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_xiyuwenduchuanganqiguzhang", 780, 2, "洗浴温度传感器故障")
        this.getPointMap["ex_huanjingwenduchuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_huanjingwenduchuanganqiguzhang", 782, 2, "环境温度传感器故障")
        this.getPointMap["ex_jiezhiyalichuanganqiguzhang"] = byteFieldObj.init(new exceptionField(), "ex_jiezhiyalichuanganqiguzhang", 784, 2, "介质压力传感器故障")
        //
        ...
        //
        this.getPointMap["se_jiarezushu"] = byteFieldObj.init(new settingField(), "se_jiarezushu", 1114, 2, "加热组数", "组", "0517", 1, 30)
        this.getPointMap["se_paiyanbaojingwendu"] = byteFieldObj.init(new settingField(), "se_paiyanbaojingwendu", 1068, 2, "排烟报警温度", "℃", "0500", 50, 300)
        this.getPointMap["se_baojingwendu"] = byteFieldObj.init(new settingField(), "se_baojingwendu", 1070, 2, "报警温度", "℃", "0501", 0, 200)
        this.getPointMap["se_tingluwendu"] = byteFieldObj.init(new settingField(), "se_tingluwendu", 1072, 2, "停炉温度", "℃", "0502", 30, 200)
        this.getPointMap["se_mubiaowendu"] = byteFieldObj.init(new settingField(), "se_mubiaowendu", 1074, 2, "目标温度", "℃", "0503", 30, 200)
        this.getPointMap["se_qiluwendu"] = byteFieldObj.init(new settingField(), "se_qiluwendu", 1076, 2, "启炉温度", "℃", "0504", 0, 200)
        this.getPointMap["se_zhuanhuohuicha"] = byteFieldObj.init(new settingField(), "se_zhuanhuohuicha", 1078, 2, "转火回差", "℃")
        this.getPointMap["se_qiluhuicha"] = byteFieldObj.init(new settingField(), "se_qiluhuicha", 1080, 2, "启炉回差", "℃", "0506", 1, 100)
        this.getPointMap["se_kaibengwendu"] = byteFieldObj.init(new settingField(), "se_kaibengwendu", 1082, 2, "开泵温度", "℃", "0507", 0, 200)
        this.getPointMap["se_guanbengwendu"] = byteFieldObj.init(new settingField(), "se_guanbengwendu", 1084, 2, "关泵温度", "℃", "0508", 0, 200)
        ...
        this.getPointMap["se_jiarezushu"] = byteFieldObj.init(new settingField(), "se_jiarezushu", 1114, 2, "加热组数", "组", "0517", 1, 100)
        ...
        this.getPointMap["se_touqieshijian_jiarezuyong_"] = byteFieldObj.init(new settingField(), "se_touqieshijian_jiarezuyong_", 1210, 2, "投切时间（加热组用）", "s", "0547", 1, 10)
        this.getPointMap["se_diaojieshijian_jiarezuyong_"] = byteFieldObj.init(new settingField(), "se_diaojieshijian_jiarezuyong_", 1212, 2, "调节时间（加热组用）", "m", "0548", 1, 10)
